...
export function renderParamsInfo() {
    ...
    container.innerHTML = `
        <div class="params-card-stack">
            <section class="params-card params-card--sliders" role="group" aria-label="Parámetros de generación">
            ...
            <section class="params-card params-card--prompt" role="group" aria-label="System Prompt">
                <header class="params-card__header">
